...
//
// The Round 0 data is broadcast to other peers of the New Committee in this message.
type DGRound2AMessage1 struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Challenges [][]byte `protobuf:"bytes,1,rep,name=challenges,proto3" json:"challenges,omitempty"`
	Omega      []byte   `protobuf:"bytes,2,opt,name=omega,proto3" json:"omega,omitempty"`
}

func (x *DGRound2AMessage1) Reset() {
	*x = DGRound2AMessage1{}
	if protoimpl.UnsafeEnabled {
...
func (x *DGRound2AMessage1) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DGRound2AMessage1) ProtoMessage() {}

func (x *DGRound2AMessage1) ProtoReflect() protoreflect.Message {
	mi := &file_protob_ecdsa_resharing_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DGRound2AMessage1.ProtoReflect.Descriptor instead.
func (*DGRound2AMessage1) Descriptor() ([]byte, []int) {
	return file_protob_ecdsa_resharing_proto_rawDescGZIP(), []int{1}
}

func (x *DGRound2AMessage1) GetChallenges() [][]byte {
	if x != nil {
		return x.Challenges
	}
	return nil
...
func (x *DGRound2AMessage1) GetOmega() []byte {
	if x != nil {
		return x.Omega
	}
	return nil
...
type DGRound2BMessage1 struct {
	...
	ParameterProof []byte   `protobuf:"bytes,8,opt,name=parameter_proof,json=parameterProof,proto3" json:"parameter_proof,omitempty"`
}

func (x *DGRound2BMessage1) Reset() {
	*x = DGRound2BMessage1{}
	if protoimpl.UnsafeEnabled {
...
func (x *DGRound2BMessage1) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DGRound2BMessage1) ProtoMessage() {}

func (x *DGRound2BMessage1) ProtoReflect() protoreflect.Message {
	mi := &file_protob_ecdsa_resharing_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DGRound2BMessage1.ProtoReflect.Descriptor instead.
func (*DGRound2BMessage1) Descriptor() ([]byte, []int) {
	return file_protob_ecdsa_resharing_proto_rawDescGZIP(), []int{2}
}

func (x *DGRound2BMessage1) GetPaillierN() []byte {
	if x != nil {
		return x.PaillierN
	}
	return nil
...
func (x *DGRound2BMessage1) GetPaillierProof() [][]byte {
	if x != nil {
...
func (x *DGRound2BMessage1) GetNTilde() []byte {
	if x != nil {
		return x.NTilde
	}
	return nil
...
func (x *DGRound2BMessage1) GetH1() []byte {
	if x != nil {
		return x.H1
	}
	return nil
...
func (x *DGRound2BMessage1) GetH2() []byte {
	if x != nil {
		return x.H2
	}
	return nil
...
func (x *DGRound2BMessage1) GetDlnproof_1() [][]byte {
	if x != nil {
		return x.Dlnproof_1
	}
	return nil
...
func (x *DGRound2BMessage1) GetDlnproof_2() [][]byte {
	if x != nil {
		return x.Dlnproof_2
	}
	return nil
...
func (x *DGRound2BMessage1) GetParameterProof() []byte {
	if x != nil {
		return x.ParameterProof
	}
	return nil
}
...
var file_protob_ecdsa_resharing_proto_rawDesc = []byte{
	...
	,
	...
	0x03, 0x28, 0x0c, 0x52, 0x09, 0x64, 0x6c, 0x6e, 0x70, 0x72, 0x6f, 0x6f, 0x66, 0x32, 0x12, 0x27,
	0x0a, 0x0f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x5f, 0x70, 0x72, 0x6f, 0x6f,
	0x66, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0e, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74,
	0x65, 0x72, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x22, 0x12, 0x0a, 0x10, 0x44, 0x47, 0x52, 0x6f, 0x75,
	0x6e, 0x64, 0x32, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x22, 0x28, 0x0a, 0x10, 0x44,
...
var file_protob_ecdsa_resharing_proto_goTypes = []interface{}{
	...
	(*DGRound2AMessage1)(nil), // 1: DGRound2aMessage1
	(*DGRound2BMessage1)(nil), // 2: DGRound2bMessage1
	(*DGRound2Message2)(nil),  // 3: DGRound2Message2
	(*DGRound3Message1)(nil),  // 4: DGRound3Message1
	(*DGRound3Message2)(nil),  // 5: DGRound3Message2
	(*DGRound4Message)(nil),   // 6: DGRound4Message
	(*common.ECPoint)(nil),    // 7: ECPoint
}
var file_protob_ecdsa_resharing_proto_depIdxs = []int32{
	7, // 0: DGRound1Message.ecdsa_pub:type_name -> ECPoint
...
func file_protob_ecdsa_resharing_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_protob_ecdsa_resharing_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DGRound2AMessage1); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_protob_ecdsa_resharing_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DGRound2BMessage1); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
